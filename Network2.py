...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, validataion_data,
            test_data, lmbda=0.0):
        ...
        num_validation_batches = size(validataion_data)/mini_batch_size
        ...
        for epoch in xrange(epochs):
            for minibatch_index in xrange(num_training_batches):
                ...
                if(iteration+1) % num_training_batches == 0:
                    ...
                    print("Epoch {0}: validataion accuracy {1:.2}".format(epoch, validation_accuracy))
        ...
        print ("Finish training network.")
        print ("Best validation accuracy of {0:.2} at {1} iteration".format(best_validation_accuracy, best_iteration))
